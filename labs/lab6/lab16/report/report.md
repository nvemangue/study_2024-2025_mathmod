...
Основная литература:
1. Королькова А. В., Кулябов Д. С. Моделирование информационных процессов.
(Учебное пособие, из которого взята лабораторная работа.) � Содержит
теоретические основы и примеры реализации моделей.
2. Клейнрок Л. Теория массового обслуживания. — М.: Машиностроение, 1979.
� Классическая работа по теории очередей, включая экспоненциальное и
равномерное распределения.
3. Саати Т. Элементы теории массового обслуживания и ее приложения. — М.:
Советское радио, 1971. � Подробно разбираются стратегии обслуживания
(раздельные и общие очереди). В результате выполнения данной
